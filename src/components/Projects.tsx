            ...
            >
              ...
              <div className="absolute bottom-6 left-8 right-8">
                <a
                  ...
                  className="flex items-center justify-center space-x-2 w-full bg-slate-800 hover:bg-slate-900 text-white py-3 px-4 rounded-lg font-semibold transition-all duration-300 group-hover:shadow-lg border border-slate-800 hover:border-slate-600"
                >
                  <Github size={18} />
